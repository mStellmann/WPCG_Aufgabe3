...
import classes.MarchingCubes;
import classes.Sphere;
import classes.Torus;
...
//		ITriangleMesh mesh = mc.computeMarchingCubes(new Sphere(1.25));
		ITriangleMesh mesh = mc.computeMarchingCubes(new Torus(0.75, 0.55));
